...
public class InitRegister implements ApplicationRunner {
    ...
    private static final String PERMISSIONS = "com.wm.demo.init.Permissions";
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        ResponseEntity<String> stringResponseEntity = restTemplate.postForEntity("http://127.0.0.1:8201/register", entity, String.class);
    }
